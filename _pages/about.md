...
<div style="font-size: 16px; line-height: 1.6; margin-bottom: 30px; background-color: #f9f9f9; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px;">
        ...
        <div style="width: calc(50% - 30px); min-width: 300px; background: white; border-radius: 15px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: all 0.3s ease-in-out;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 30px rgba(0,0,0,0.15)'; this.style.borderTop='3px solid #2980b9';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.1)'; this.style.borderTop='none';">
            <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                <div style="width: 90px; height: 90px; border-radius: 50%; overflow: hidden; border: 3px solid #f0f0f0; flex-shrink: 0;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <div style="font-size: 16px; color: #666;">CEO of Autoenhance.ai</div>
                </div>
            </div>
        ...
        <div style="width: calc(50% - 30px); min-width: 300px; background: white; border-radius: 15px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: all 0.3s ease-in-out;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 30px rgba(0,0,0,0.15)'; this.style.borderTop='3px solid #2980b9';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.1)'; this.style.borderTop='none';">
            <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <div style="font-size: 16px; color: #666;">Assistant Professor (Sr.) at VU Amsterdam</div>
                </div>
            </div>
        ...
        <div style="width: calc(50% - 30px); min-width: 300px; background: white; border-radius: 15px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: all 0.3s ease-in-out;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 30px rgba(0,0,0,0.15)'; this.style.borderTop='3px solid #2980b9';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.1)'; this.style.borderTop='none';">
            <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <div style="font-size: 16px; color: #666;">Product Manager @ Jio Platforms</div>
                </div>
            </div>
        ...
        <div style="width: calc(50% - 30px); min-width: 300px; background: white; border-radius: 15px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: all 0.3s ease-in-out;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 30px rgba(0,0,0,0.15)'; this.style.borderTop='3px solid #2980b9';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.1)'; this.style.borderTop='none';">
            <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <div style="font-size: 16px; color: #666;">Principal Data Scientist @ Mastercard</div>
                </div>
            </div>
